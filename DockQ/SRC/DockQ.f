...
*****instructions ----------------->
      ...
      if(fnam.eq.' '.or.fnam.eq.'?'.or.fnam.eq.'-h')then
        write(*,*)'-------------------------------------------'
        write(*,*)
        write(*,*)'This version of DockQ uses all atoms'
        write(*,*)'If you want the (~6.5X) FASTER CA-only version, 
     &run: ./DockQCAonly.exe in staid'
        write(*,*)'Fnat calculated at a all-atom cutoff of 5 A'
...
!==============================================================================
!============ DETTERMINE FIRST AND LAST RESIDUE SEQUENCE NUMBER IN BOTH STRUCTURES ==================
